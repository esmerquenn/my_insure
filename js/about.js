...
function updateContent(page, language) {
  ...
  <h1   class="text-2xl font-semibold border-b-2 pb-3 border-red-600 text-center text-white dark:text-slate-50 mb-8">
    Lorem Ipsum – <span class=" text-[#EA1918]">my</span>insure.com saytının təsisçisi
  </h1>
  ...
  <div class="md:flex md:items-start">
    ...
    <div class="md:w-2/3 md:pl-10">
      <p class="text-lg text-slate-50 leading-8 dark:text-gray-300">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloremque, sit nisi atque quos distinctio aspernatur est adipisci cupiditate temporibus, rerum recusandae cum ipsam dicta repellat culpa voluptas deleniti minus omnis esse iure. Numquam earum explicabo enim accusamus fugit. Sint voluptatibus deleniti amet culpa earum cumque illum cupiditate quas iure quia, dolor, quasi distinctio veritatis in beatae autem ipsum similique vitae modi animi? Ipsa et a consequuntur asperiores quaerat neque exercitationem.
      ...
      ru: `<div class=" container md:w-[80%]  mx-auto py-10 px-5 md:px-20">
  <h1   class="text-2xl font-semibold border-b-2 pb-3 border-red-600 text-center text-white dark:text-slate-50 mb-8">
   Lorem Ipsum – <span class="text-[#EA1918]">my</span>insure.com основатель сайта
