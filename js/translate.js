const translations = {
  az: {
    ...
    website_info:
      "www.Myinsure.com saytı 19.07.2024-cü il tarixində Mircəfər Cəfərov tərəfindən təsis edilmiş, <br/>  Azərbaycan Respublikası Mərkəzi Bankı tərəfindən verilmiş SA – 0337  saylı lisenziya əsasında sayt üzərindən sığorta fəaliyyətinə başlanmışdır.",
    contact: "Əlaqə",
    address: "Bakı ş. Səməd Vurğun 99 küçə",
    ...
    property_insurance_advice_paragraph:
      "Adından da göründüyü kimi sizin üçün vacib olan bütün əmlaklarınızın sığortası gələcəyiniz üçün edə biləcəyiniz əsas zəmanətlərdən biridir. Ona görə də avtomobilinizi sığorta etdirməyi unutmayın və Myinsure.com kimi etibarlı sığorta vasitəçilərinə müraciət etməyinizi tövsiyə edirik.",
    online_insurance_advantage_heading: "Onlayn İcbari sığorta vaxt qazandırır",
    online_insurance_advantage_paragraph:
      "Onlayn icbari sığorta almaq sizin üçün əlavə vaxt qazandırır. Müxtəlif sığorta agentlərinin sizi zəng edib narahat etməsindən narahat olmusunuzsa Myinsure.com ilə onlayn icbari avto sığorta ala bilərsiniz. Bunun üçün sizə sadəcə şəxsi məlumatlarınızın yəni - şəxsiyyət vəsiqəsi, sürücülük vəsiqəsi və texpassport lazım olacaq. Daha sonra sığorta şirkətini seçərək icbari avto sığorta müqaviləniz üçün nəzərdə tutulmuş məbləği ödəyə biləcəksiniz. Sığorta ödənişini həyata keçirdikdən sonra, sizin avtonəqliyyat vasitəniz sığorta edilmiş olacaq və rahatlıqla avtonəqliyyat vasitənizi idarə edə bilərsiniz.",
    ...
    online_auto_insurance_advantage_paragraph:
      "Onlayn İcbari Avto Sığorta almağın üstünlükləri barədə deyə bilərik ki, cərimələr hazırda yollarda quraşdırılmış kameralar tərəfindən avtomatik olaraq edilir. Bunu nəzərə alaraq maksimum dərəcədə çalışmalısınız ki, maşın sığortası bitmədən siz yeni sığortanızı əldə edəsiniz. Əgər icbari sığorta bitibsə sığortanızı yeniləmədən nəqliyyat vasitənizi idarə etməməlisiniz. Hazırda isə icbari sığortanızı lazım olan anda yeniləyə bilməyiniz üçün Myinsure.com onlayn sığorta platforması var. Siz Myinsure.com saytı vasitəsi ilə maşın üçün icbari avto sığortanı 1 dəqiqə ərzində əldə edərək yolunuza rahatlıqla davam edə biləcəksiniz.",
    ...
    online_kasko_opportunity_text: `Onlayn Kasko sığorta sizin maşınınızı tam olaraq sığorta edir. Kasko sığorta paketlərini əldə etmək üçün sizə ən rahat üsul olaraq Myinsure.com portalını təklif edirik. Siz Parking kasko sığorta paketindən əlavə tam kasko sığorta paketlərini də bizə müraciət edərək əldə edə bilərsiniz.`,
    kasko_pricing: "KASKO sığortasının qiymətinini müəyyən edilməsi:",
    kasko_pricing_text: `Kasko sığorta alışı zamanı sığorta şirkətləri tərəfindən avtomobilin mühərrik həcmi, real bazar dəyəri, vəziyyəti, marka və modeli dəyərləndirilərək qiymət təyin edilir. Hətta bu qiymət təyin etmə mexanizminə sizin sürücülük təcrübənizin də təsiri mövcuddur. Myinsure.com sizin üçün müxtəlif sığorta şirkətləri ilə əməkdaşlıq etdiyi üçün ən uyğun kasko sığorta paketlərini və müxtləif formatlı kasko sığorta paketlərini təklif edə bilir. Bunun üçün sadəcə bizimlə əlaqə saxlamanız yetərlidir. Biz sizin üçün Paşa Sığorta, Atəşgah sığorta, Bakı Sığorta, Xalq Sığorta və digər şirkətlərin təkliflərini bir gün ərzində verə bilirik.`,
  ...
  ru: {
    ...
    website_info:
      "Сайт www.Myinsure.com был основан Мирджафаром Джафаровым 19.07.2024 года, <br/> и на основании лицензии № SA – 0337, выданной Центральным банком Азербайджанской Республики, начата страховая деятельность на сайте.",
    contact: "Контакты",
    address: "г. Баку, ул. Самеда Вургуна, 99",
    ...
    property_insurance_advice_paragraph:
      "Как видно из названия, страхование всего вашего имущества - это одна из основных гарантий вашего будущего. Поэтому не забудьте застраховать свой автомобиль и обратитесь к надежным страховым компаниям, таким как Myinsure.com.",
    online_insurance_advantage_heading: "Онлайн обязательное страхование экономит время",
    online_insurance_advantage_paragraph:
      "Получение онлайн обязательного страхования экономит ваше время. Если вас беспокоят звонки от различных страховых агентов, вы можете приобрести онлайн обязательное автострахование с Myinsure.com. Для этого вам понадобятся ваши личные данные, а именно - удостоверение личности, водительское удостоверение и технический паспорт. Затем вы сможете выбрать страховую компанию и оплатить сумму, предусмотренную для вашего обязательного автострахования. После оплаты страхового взноса ваше транспортное средство будет застраховано, и вы сможете спокойно управлять своим автомобилем.",
    online_auto_insurance_advantage_heading: "Преимущества получения онлайн обязательного автострахования",
    online_auto_insurance_advantage_paragraph:
      "О преимуществах получения онлайн обязательного автострахования можно сказать, что штрафы в настоящее время фиксируются автоматическими камерами на дорогах. Учитывая это, вы должны постараться максимально вовремя получить новую страховку до истечения срока действия старой. Если обязательное страхование истекло, не управляйте транспортным средством, не обновив страховку. В настоящее время существует онлайн-страховая платформа Myinsure.com, которая позволяет вам обновить обязательную страховку в нужный момент. С помощью сайта Myinsure.com вы можете получить обязательное автострахование для своего автомобиля всего за 1 минуту и продолжить свой путь без проблем.",
